...
- ”appは壊れています”というエラーがでた場合は、[FAQ](FAQ#macos-error-this-app-is-damaged-)を参照してください。
...
[Resamplers](Resamplers-and-Wavtools)のリストで互換性があるか確認してください。
...
>より詳しい説明は、[Phonemizers（日本語）](Phonemizers（日本語）)  
