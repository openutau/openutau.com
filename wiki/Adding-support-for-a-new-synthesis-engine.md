...
nav_order: 5
---
OpenUtau is an open source singing synthesis platform. Anyone who develops their singing synthesis engine can use OpenUtau as its UI. This article introduces how to add support for a new synthesis engine, taking [DiffSinger](https://github.com/openutau/OpenUtau/pull/882) as an example. DiffSinger is a typical machine learning based singing synthesis engine that uses the classic packaging format
...
## Define singer type
To define a singer type, you'll need to create a singer class that inherits [USinger](https://github.com/openutau/OpenUtau/blob/master/OpenUtau.Core/Ustx/USinger.cs#L205). Here are some important features you need to implement in this class:
...
An example is [DiffSingerSinger](https://github.com/openutau/OpenUtau/blob/master/OpenUtau.Core/DiffSinger/DiffSingerSinger.cs)
...
- [OpenUtau.Core/Ustx/USinger.cs](https://github.com/openutau/OpenUtau/blob/d4b3cc2bd180d7fdcb7c459ec6aa99bde4273cf7/OpenUtau.Core/Ustx/USinger.cs#L188-L203)
- [OpenUtau.Core/Classic/ClassicSingerLoader.cs](https://github.com/openutau/OpenUtau/blob/d4b3cc2bd180d7fdcb7c459ec6aa99bde4273cf7/OpenUtau.Core/Classic/ClassicSingerLoader.cs#L10-L15)
- [OpenUtau.Core/Render/Renderers.cs](https://github.com/openutau/OpenUtau/blob/d4b3cc2bd180d7fdcb7c459ec6aa99bde4273cf7/OpenUtau.Core/Render/Renderers.cs#L11-L36) (associate your singer type to your renderer)
- [OpenUtau/ViewModels/SingerSetupViewModel.cs](https://github.com/openutau/OpenUtau/blob/master/OpenUtau/ViewModels/SingerSetupViewModel.cs#L33)

## Add a renderer for your synthesis engine
Starting from here, we'll add our synthesis code into OpenUtau. Create a new folder under [OpenUtau.Core](https://github.com/openutau/OpenUtau/tree/master/OpenUtau.Core) and put all the code for your synthesis engine there.

A renderer should implement [IRenderer](https://github.com/openutau/OpenUtau/blob/master/OpenUtau.Core/Render/IRenderer.cs). Here are the main features of a renderer:
...
An example is [DiffSingerRenderer](https://github.com/openutau/OpenUtau/blob/master/OpenUtau.Core/DiffSinger/DiffSingerRenderer.cs)
